...
gcc -Wall -Wextra -pedantic -std=c11 -Isrc -c -o build\capability_core.o src\reference\capability_core_modified.c
if %ERRORLEVEL% neq 0 (
...
gcc -Wall -Wextra -pedantic -std=c11 -Isrc -c -o build\test_harness.o src\test_harness.c
if %ERRORLEVEL% neq 0 (
...
:: Link everything
echo Linking...
gcc -o test_harness.exe build\test_harness.o build\capability_core.o
if %ERRORLEVEL% neq 0 (
    echo Failed to link
    exit /b 1
)
